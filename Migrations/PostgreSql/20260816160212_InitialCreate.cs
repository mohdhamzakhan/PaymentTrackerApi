...
namespace PaymentTrackerApi.Migrations.PostgreSql
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerMobileNo = table.Column<string>(type: "text", nullable: false),
                    ...
                    VendorMobileNo = table.Column<string>(type: "text", nullable: true),
                    LocationOfPurchase = table.Column<string>(type: "text", nullable: false),
                    ...
                    TotalInvoiceAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ExtraFieldsJson = table.Column<string>(type: "text", nullable: true),
                    RawPayloadJson = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    BillImageUrl = table.Column<string>(type: "text", nullable: true),
                    BillImageData = table.Column<byte[]>(type: "bytea", nullable: true),
                    BillImageContentType = table.Column<string>(type: "text", nullable: true),
                    QrCodeImageUrl = table.Column<string>(type: "text", nullable: true),
                    QrCodeImageData = table.Column<byte[]>(type: "bytea", nullable: true),
                    QrCodeImageContentType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CampaignLogId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentDetails_CampaignLogs_CampaignLogId",
                        column: x => x.CampaignLogId,
                        principalTable: "CampaignLogs",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignLogs_Destination",
                table: "CampaignLogs",
                column: "Destination");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_CampaignLogId",
                table: "PaymentDetails",
                column: "CampaignLogId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_PhoneNumber",
                table: "PaymentDetails",
                column: "PhoneNumber");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_UtrNumber",
                table: "PaymentDetails",
                column: "UtrNumber");
